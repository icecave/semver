...
abstract class TypeCheck
{
    ...
    {
        $validatorClassName = '\\Icecave\\SemVer\\TypeCheck\\Validator\\' . $className . 'TypeCheck';
    ...
    {
        return new \Eloquent\Typhoon\Configuration\RuntimeConfiguration(\Eloquent\Cosmos\ClassName::fromString('\\Icecave\\SemVer\\TypeCheck'), false);
    }
